...
public class CalendarAqDialog extends DialogFragment implements View.OnClickListener {
    ...
    public Date2Listner listner;

    public interface Date2Listner{
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.button:
                ...
                listner.onAqDateSelected(year, month, day);
                break;
        }
        this.dismiss();
    }
    ...
    public void onAttach(Context context) {
        ...
        try{
            listner = (Date2Listner) getTargetFragment();
